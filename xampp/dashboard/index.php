<?php
  $directorio = '../';
  $Lista = '';
  // Obtener nombres de archivos y directorios
  ...
  foreach ($elementos as $elemento) {
      ...
      if (is_dir($ruta)) {
          $os = array("..", ".", "webalizer", "xampp", "dashboard");
          if(!in_array($elemento, $os)) {
            $carpetas[] = $elemento;
          }
      }
  }
  ...
  foreach ($carpetas as $carpeta) {
      $Lista .= "<li class='item'><a href='/{$carpeta}'>{$carpeta}</a></li>";
  }
?>
...
<div class="row">
  <div class="large-12 columns">
    <h2>Welcome to XAMPP for Windows 8.0.28</h2>
  </div>
</div>
<div class="row">
  <div class="large-12 columns">
